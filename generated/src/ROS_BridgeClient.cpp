...
#include <pilot/ros_bridge/ROS_BridgeClient.hxx>
...
ROS_BridgeClient::ROS_BridgeClient(const std::string& service_name)
	:	Client::Client(vnx::Hash64(service_name))
{
}

ROS_BridgeClient::ROS_BridgeClient(vnx::Hash64 service_addr)
	:	Client::Client(service_addr)
{
}

::vnx::Object ROS_BridgeClient::vnx_get_config_object() {
	...
	if(auto _result = std::dynamic_pointer_cast<const ::vnx::ModuleInterface_vnx_get_config_object_return>(_return_value)) {
		...
		throw std::logic_error("ROS_BridgeClient: invalid return value");
	}
}

::vnx::Variant ROS_BridgeClient::vnx_get_config(const std::string& name) {
...
void ROS_BridgeClient::vnx_set_config_object(const ::vnx::Object& config) {
	auto _method = ::vnx::ModuleInterface_vnx_set_config_object::create();
	_method->config = config;
	vnx_request(_method, false);
}

void ROS_BridgeClient::vnx_set_config_object_async(const ::vnx::Object& config) {
	auto _method = ::vnx::ModuleInterface_vnx_set_config_object::create();
	_method->config = config;
	vnx_request(_method, true);
}

void ROS_BridgeClient::vnx_set_config(const std::string& name, const ::vnx::Variant& value) {
...
void ROS_BridgeClient::vnx_set_config_async(const std::string& name, const ::vnx::Variant& value) {
	auto _method = ::vnx::ModuleInterface_vnx_set_config::create();
	_method->name = name;
	_method->value = value;
	vnx_request(_method, true);
...
::vnx::TypeCode ROS_BridgeClient::vnx_get_type_code() {
...
std::shared_ptr<const ::vnx::ModuleInfo> ROS_BridgeClient::vnx_get_module_info() {
...
void ROS_BridgeClient::vnx_restart() {
	auto _method = ::vnx::ModuleInterface_vnx_restart::create();
	vnx_request(_method, false);
}

void ROS_BridgeClient::vnx_restart_async() {
	auto _method = ::vnx::ModuleInterface_vnx_restart::create();
	vnx_request(_method, true);
}

void ROS_BridgeClient::vnx_stop() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, false);
}

void ROS_BridgeClient::vnx_stop_async() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, true);
}

vnx::bool_t ROS_BridgeClient::vnx_self_test() {
