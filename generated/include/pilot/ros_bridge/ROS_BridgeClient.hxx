...
#ifndef INCLUDE_pilot_ros_bridge_ROS_Bridge_CLIENT_HXX_
#define INCLUDE_pilot_ros_bridge_ROS_Bridge_CLIENT_HXX_
...
class ROS_BridgeClient : public vnx::Client {
public:
	ROS_BridgeClient(const std::string& service_name);
	
	ROS_BridgeClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_pilot_ros_bridge_ROS_Bridge_CLIENT_HXX_
