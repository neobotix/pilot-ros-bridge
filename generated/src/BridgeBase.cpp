...
std::string BridgeBase::get_type_name() const {
	return "pilot.ros_bridge.Bridge";
}

const vnx::TypeCode* BridgeBase::get_type_code() const {
	return pilot::ros_bridge::vnx_native_type_code_BridgeBase;
}

void BridgeBase::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = pilot::ros_bridge::vnx_native_type_code_BridgeBase;
...
vnx::Object BridgeBase::to_object() const {
	vnx::Object _object;
	_object["__type"] = "pilot.ros_bridge.Bridge";
...
void write(TypeOutput& out, const ::pilot::ros_bridge::BridgeBase& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = pilot::ros_bridge::vnx_native_type_code_BridgeBase;
