...
#ifndef INCLUDE_pilot_ros_bridge_ROS_BridgeBase_HXX_
#define INCLUDE_pilot_ros_bridge_ROS_BridgeBase_HXX_
...
class ROS_BridgeBase : public ::vnx::Module {
public:
	...
	std::vector<::vnx::TopicPtr> pilot_topics;
	...
	static constexpr uint64_t VNX_TYPE_ID = 0xfb8d4538783631feull;
	
	ROS_BridgeBase(const std::string& _vnx_name);
	...
	friend std::ostream& operator<<(std::ostream& _out, const ROS_BridgeBase& _value);
	friend std::istream& operator>>(std::istream& _in, ROS_BridgeBase& _value);
...
#endif // INCLUDE_pilot_ros_bridge_ROS_BridgeBase_HXX_
